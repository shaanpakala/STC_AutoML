...
class ETC(nn.Module):
    ...
    def __init__(self, 
        ...
        while (cond):
            ...
            for i, (train_index, test_index) in enumerate(kf.split(self.sparse_tensor.indices().t())):
                ...
                model_type, rank = tuple(model_type_rank.split('_'))
                            
                new_model = train_tensor_completion(model_type = model_type,
                                                    train_indices = current_indices,
                                                    train_values = current_values,
                                                    tensor_size = self.sparse_tensor.size(),
                                                    rank = int(rank),
    ...
    def forward(self, idxs):
        ...
        elif (self.agg_func == 'learned_mlp'):
        ...
        elif(self.agg_func == 'learned_cnn'):
